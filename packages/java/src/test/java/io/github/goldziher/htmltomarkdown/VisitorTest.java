...
import io.github.goldziher.htmltomarkdown.visitor.*;
...
class VisitorTest {
    ...
    class NodeContextTests {
        ...
        void testCreateNodeContext() {
            NodeContext ctx = new NodeContext(
                NodeType.PARAGRAPH, "p", List.of(), 1, 0, "body", true
            );
        ...
        void testNodeContextWithAttributes() {
            List<Attribute> attrs = List.of(
                ...
                new Attribute("id", "submit")
            );
            NodeContext ctx = new NodeContext(
                NodeType.ELEMENT, "button", attrs, 2, 1, "form", true
            );
        ...
        void testGetMissingAttribute() {
            NodeContext ctx = new NodeContext(
                NodeType.ELEMENT, "div", List.of(), 0, 0, null, false
            );
        ...
        void testIsTextNode() {
            NodeContext textCtx = new NodeContext(
                NodeType.TEXT, "", List.of(), 1, 0, "p", true
            );
            assertTrue(textCtx.isTextNode());

            NodeContext elemCtx = new NodeContext(
                NodeType.ELEMENT, "div", List.of(), 0, 0, null, false
            );
        ...
        void testIsHeading() {
            NodeContext headingCtx = new NodeContext(
                NodeType.HEADING, "h1", List.of(), 1, 0, "body", false
            );
            assertTrue(headingCtx.isHeading());

            NodeContext paraCtx = new NodeContext(
                NodeType.PARAGRAPH, "p", List.of(), 1, 1, "body", false
            );
        ...
        void testIsRoot() {
            NodeContext root = new NodeContext(
                NodeType.ELEMENT, "html", List.of(), 0, 0, null, false
            );
            assertTrue(root.isRoot());

            NodeContext child = new NodeContext(
                NodeType.ELEMENT, "body", List.of(), 1, 0, "html", false
            );
        ...
        void testHasParent() {
            NodeContext withParent = new NodeContext(
                NodeType.ELEMENT, "p", List.of(), 1, 0, "body", false
            );
            assertTrue(withParent.hasParent());

            NodeContext noParent = new NodeContext(
                NodeType.ELEMENT, "html", List.of(), 0, 0, null, false
            );
        ...
        void testNullNodeType() {
            assertThrows(NullPointerException.class, () -> new NodeContext(
                null, "p", List.of(), 0, 0, null, false
            ));
        }
        ...
        void testNullTagName() {
            assertThrows(NullPointerException.class, () -> new NodeContext(
                NodeType.ELEMENT, null, List.of(), 0, 0, null, false
            ));
        }
        ...
        void testNegativeDepth() {
            assertThrows(IllegalArgumentException.class, () -> new NodeContext(
                NodeType.ELEMENT, "p", List.of(), -1, 0, null, false
            ));
        }
        ...
        void testNegativeIndex() {
            assertThrows(IllegalArgumentException.class, () -> new NodeContext(
                NodeType.ELEMENT, "p", List.of(), 0, -1, null, false
            ));
        }
    ...
    class VisitorImplementationTests {
        ...
        void testDefaultVisitor() {
            ...
            NodeContext ctx = new NodeContext(
                NodeType.PARAGRAPH, "p", List.of(), 1, 0, "body", false
            );
        ...
        void testCustomVisitorFilterLinks() {
            ...
            NodeContext ctx = new NodeContext(
                NodeType.LINK, "a", List.of(), 2, 0, "p", true
            );

            assertEquals(VisitResult.Skip.INSTANCE, visitor.visitLink(ctx, "https://example.com", "link", null));
    ...
    class IntegrationTests {
        ...
        void testLinkFilteringVisitor() {
            ...
            assertEquals(VisitResult.Skip.INSTANCE, visitor.visitLink(ctx, "https://evil.com", "bad", null));
            assertEquals(VisitResult.Continue.INSTANCE, visitor.visitLink(ctx, "https://good.com", "good", null));
        }
        ...
        void testCodeBlockVisitor() {
            ...
            NodeContext ctx = new NodeContext(
                NodeType.PRE, "pre", List.of(), 2, 0, "body", false
            );
        ...
        void testTableRowVisitor() {
            ...
            NodeContext ctx = new NodeContext(
                NodeType.TABLE_ROW, "tr", List.of(), 2, 0, "tbody", false
            );
    ...
    class MemorySafetyTests {
        ...
        void testAttributesImmutable() {
            ...
            NodeContext ctx = new NodeContext(
                NodeType.ELEMENT, "div", attrs, 0, 0, null, false
            );
