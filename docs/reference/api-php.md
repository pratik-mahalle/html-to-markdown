...
```php
public static function tableTotalColumns(NodeHandle $nodeHandle, Parser $parser, DomContext $domCtx): int
```
...
```php
public static function handleTable(NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, DomContext $domCtx, int $depth): void
```
...
```php
public static function handleCaption(NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function getColspan(NodeHandle $nodeHandle, Parser $parser): int
```
...
```php
public static function getColspanRowspan(NodeHandle $nodeHandle, Parser $parser): UsizeUsize
```
...
```php
public static function collectTableCells(NodeHandle $nodeHandle, Parser $parser, DomContext $domCtx, array<NodeHandle> $cells): void
```
...
```php
public static function convertTableCell(NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, string $tagName, DomContext $domCtx): void
```
...
```php
public static function appendLayoutRow(NodeHandle $rowHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, DomContext $domCtx): void
```
...
```php
public static function convertTableRow(NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $rowIndex, bool $hasSpan, array<?int> $rowspanTracker, int $totalCols, int $headerCols, DomContext $domCtx, int $depth, bool $isHeader): void
```
...
| `rowspanTracker` | `array<?int>` | Yes | Mutable array tracking rowspan remainder for each column |
...
```php
public static function scanTable(NodeHandle $nodeHandle, Parser $parser, DomContext $domCtx): TableScan
```
...
```php
public static function dispatchTableHandler(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function dispatchBlockHandler(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function handle(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function dispatchFormHandler(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function handleBlockquote(NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleCode(NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handlePre(NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleGraphic(NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleImg(NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleLink(NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function dispatchInlineHandler(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function calculateListContinuationIndent(int $depth): int
```
...
```php
public static function isLooseList(NodeHandle $nodeHandle, Parser $parser, DomContext $domCtx): bool
```
...
```php
public static function addListContinuationIndent(string $output, int $listDepth, bool $blankLine, ConversionOptions $options): void
```
...
```php
public static function continuationIndentString(int $listDepth, ConversionOptions $options): ?string
```
...
```php
public static function addListLeadingSeparator(string $output, Context $ctx): void
```
...
```php
public static function addNestedListTrailingSeparator(string $output, Context $ctx): void
```
...
```php
public static function calculateListNestingDepth(Context $ctx): int
```
...
```php
public static function isListItem(NodeHandle $nodeHandle, Parser $parser, DomContext $domCtx): bool
```
...
```php
public static function processListChildren(NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, bool $isOrdered, bool $isLoose, int $nestedDepth, int $startCounter, DomContext $domCtx): void
```
...
```php
public static function dispatchListHandler(string $tagName, NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function convertHtml(string $html, ConversionOptions $options): string
```
...
```php
public static function convertHtmlWithVisitor(string $html, ConversionOptions $options, ?VisitorHandle $visitor = null): string
```
...
```php
public static function dispatchMediaHandler(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function extractPlainText(VDom $dom, Parser $parser, ConversionOptions $options): string
```
...
```php
public static function handleDfn(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleAbbr(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleTimeData(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleCite(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleQ(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleHgroup(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleDl(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleDt(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleDd(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleMenu(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleFigure(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleFigcaption(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleDetails(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleSummary(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function handleDialog(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function dispatchSemanticHandler(string $tagName, NodeHandle $nodeHandle, Parser $parser, string $output, ConversionOptions $options, Context $ctx, int $depth, DomContext $domCtx): bool
```
...
```php
public static function floorCharBoundary(string $s, int $index): int
```
...
```php
public static function handleVisitorElementStart(VisitorHandle $visitorHandle, string $tagName, NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, Context $ctx, int $depth, DomContext $domCtx): VisitAction
```
...
```php
public static function handleVisitorElementEnd(VisitorHandle $visitorHandle, string $tagName, NodeHandle $nodeHandle, HtmlTag $tag, Parser $parser, string $output, int $elementOutputStart, Context $ctx, int $depth, DomContext $domCtx): void
```
...
```php
public static function escape(string $text, bool $escapeMisc, bool $escapeAsterisks, bool $escapeUnderscores, bool $escapeAscii): Str
```
...
```php
public static function chomp(string $text): StrStrStr
```
...
```php
public static function normalizeWhitespaceCow(string $text): Str
```
...
```php
public static function decodeHtmlEntitiesCow(string $text): Str
```
...
```php
public static function underline(string $text, string $padChar): string
```
...
```php
public static function indent(string $text, int $level, string $indentStr): string
```
...
```php
public static function buildDocumentStructure(VDom $dom): DocumentStructure
```
...
```php
public static function buildNodeContext(NodeType $nodeType, string $tagName, array<string, string> $attributes, int $depth, int $indexInParent, ?string $parentTag = null, bool $isInline): NodeContext
```
...
| `attributes` | `array<string, string>` | Yes | All HTML attributes as key-value pairs |
...
```php
public static function convertWithVisitor(string $html, ?ConversionOptions $options = null, ?VisitorHandle $visitor = null): string
```
...
```php
public static function conversionOptionsFromJson(string $json): ConversionOptions
```
...
```php
public static function conversionOptionsUpdateFromJson(string $json): ConversionOptionsUpdate
```
...
```php
public static function inlineImageConfigFromJson(string $json): InlineImageConfig
```
...
```php
public static function metadataConfigFromJson(string $json): MetadataConfig
```
...
```php
public static function fromElements(array<string> $elements): InlineImageConfig
```
...
```php
public function shouldKeepImages(string $element): bool
```
...
```php
public static function default(): InlineImageConfig
```
...
```php
public function getOrInsert(string $url, string $title): int
```
...
```php
public function pushHeading(int $level, string $text, string $id): int
```
...
```php
public function pushParagraph(string $text): int
```
...
```php
public function pushListStart(bool $ordered): int
```
...
```php
public function pushListEnd(): void
```
...
```php
public function pushListItem(string $text): int
```
...
```php
public function pushTable(TableGrid $grid): int
```
...
```php
public function pushImage(string $src, string $alt): int
```
...
```php
public function pushCode(string $text, string $language): int
```
...
```php
public function pushQuoteStart(): int
```
...
```php
public function pushRawBlock(string $format, string $content): int
```
...
```php
public function finish(): DocumentStructure
```
...
```php
public static function default(): StructureCollector
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `rowCounts` | `array<int>` | `[]` | Number of cells in each row |
