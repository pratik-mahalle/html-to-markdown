...
#define HTML_TO_MARKDOWN_VERSION_MINOR 28
#define HTML_TO_MARKDOWN_VERSION_PATCH 4
#define HTML_TO_MARKDOWN_VERSION "2.28.4"
...
/* Symbol visibility */
#ifndef HTM_EXPORT
  #if defined(HTM_STATIC)
    #define HTM_EXPORT
  #elif defined(_WIN32) || defined(__CYGWIN__)
    #ifdef HTML_TO_MARKDOWN_BUILDING
      #define HTM_EXPORT __declspec(dllexport)
    #else
      #define HTM_EXPORT __declspec(dllimport)
    #endif
  #elif defined(__GNUC__) || defined(__clang__)
    #define HTM_EXPORT __attribute__((visibility("default")))
  #else
    #define HTM_EXPORT
  #endif
#endif
 ...
 * ```
 */
HTM_EXPORT struct HtmlToMarkdownVisitResult html_to_markdown_visit_result_continue(void);
 ...
 * ```
 */
HTM_EXPORT struct HtmlToMarkdownVisitResult html_to_markdown_visit_result_custom(char *output);
 ...
 * ```
 */
HTM_EXPORT struct HtmlToMarkdownVisitResult html_to_markdown_visit_result_skip(void);
 ...
 * ```
 */
HTM_EXPORT struct HtmlToMarkdownVisitResult html_to_markdown_visit_result_preserve_html(void);
