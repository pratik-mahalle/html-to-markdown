 ...
 *
 * <p>Implement this interface to intercept and customize the conversion
 * process. Each method is called at appropriate points during tree traversal.
 *
 * <p><b>Default Behavior:</b> All methods default to returning
 * {@link VisitResult.Continue}, which instructs the converter to use its
 * standard behavior. Override specific methods to customize processing.
 *
 * <p><b>Performance Notes:</b>
 * <ul>
 *   <li>{@link #visitText(NodeContext, String)} is called very frequently
 *       (100+ times per document). For performance, return {@code Continue}
 *       quickly if you're not interested in modifying the text.</li>
 *   <li>String data in callbacks is borrowed; copy immediately if you
 *       need to persist it.</li>
 *   <li>Callbacks must be thread-safe if the visitor is shared across
 *       threads.</li>
 * </ul>
 *
 * @since 2.17.0
...
public interface Visitor {
     ...
     * @return the visitor result
     */
    default VisitResult visitElementEnd(final NodeContext ctx,
            final String output) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitText(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitLink(final NodeContext ctx, final String href,
     ...
     * @return the visitor result
     */
    default VisitResult visitImage(final NodeContext ctx, final String src,
     ...
     * @return the visitor result
     */
    default VisitResult visitHeading(final NodeContext ctx,
            final int level, final String text, final String id) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitCodeBlock(final NodeContext ctx,
     ...
     * @return the visitor result
     */
    default VisitResult visitCodeInline(final NodeContext ctx,
            final String code) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitListItem(final NodeContext ctx,
            final boolean ordered, final String marker, final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitListStart(final NodeContext ctx,
     ...
     * @return the visitor result
     */
    default VisitResult visitListEnd(final NodeContext ctx,
     ...
     * @return the visitor result
     */
    default VisitResult visitTableRow(final NodeContext ctx,
            final List<String> cells, final boolean isHeader) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitTableEnd(final NodeContext ctx,
            final String output) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitBlockquote(final NodeContext ctx,
            final String content, final int depth) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitStrong(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitEmphasis(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitStrikethrough(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitUnderline(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitSubscript(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitSuperscript(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitMark(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitCustomElement(final NodeContext ctx,
            final String tagName, final String html) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitDefinitionTerm(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitDefinitionDescription(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitDefinitionListEnd(final NodeContext ctx,
            final String output) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitForm(final NodeContext ctx,
     ...
     * @return the visitor result
     */
    default VisitResult visitInput(final NodeContext ctx,
            final String inputType, final String name, final String value) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitButton(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitDetails(final NodeContext ctx,
            final boolean open) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitSummary(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitFigcaption(final NodeContext ctx,
            final String text) {
        return VisitResult.Continue.INSTANCE;
    }
     ...
     * @return the visitor result
     */
    default VisitResult visitFigureEnd(final NodeContext ctx,
            final String output) {
        return VisitResult.Continue.INSTANCE;
    }
}
