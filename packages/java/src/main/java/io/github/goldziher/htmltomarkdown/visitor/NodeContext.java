 ...
 *
 * <p>Passed to all visitor callbacks to provide metadata about the current element.
 * All data is borrowed from the Rust converter and valid only during the callback invocation.
 *
 * <p><b>Memory Safety Note:</b> Do NOT attempt to store or persist strings from this
 * context. All pointers are borrowed and become invalid after the callback returns.
 * If you need persistent data, copy the string contents immediately.
 *
