...
// Generate complex HTML (matching Python and Node.js benchmarks)
...
async function runBenchmarks() {
  console.log("@html-to-markdown/wasm - WebAssembly Benchmarks");
