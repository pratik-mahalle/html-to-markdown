...
public record ConversionOptionsUpdate(@JsonProperty("heading_style") Optional<HeadingStyle> headingStyle,
		@JsonProperty("list_indent_type") Optional<ListIndentType> listIndentType,
		@JsonProperty("list_indent_width") Optional<Long> listIndentWidth, Optional<String> bullets,
		...
		@JsonProperty("code_language") Optional<String> codeLanguage, Optional<Boolean> autolinks,
		...
		@JsonProperty("strip_newlines") Optional<Boolean> stripNewlines, Optional<Boolean> wrap,
		@JsonProperty("wrap_width") Optional<Long> wrapWidth,
		@JsonProperty("convert_as_inline") Optional<Boolean> convertAsInline,
		@JsonProperty("sub_symbol") Optional<String> subSymbol, @JsonProperty("sup_symbol") Optional<String> supSymbol,
		...
		Optional<PreprocessingOptionsUpdate> preprocessing, Optional<String> encoding, Optional<Boolean> debug,
