...
/**
 * Allocates Panama FFM upcall stubs for an IHtmlVisitor implementation, assembles the C vtable in
 * native memory, and provides static registerHtmlVisitor/unregisterHtmlVisitor helpers.
 */
public final class HtmlVisitorBridge implements AutoCloseable {
  ...
  private static final ConcurrentHashMap<String, HtmlVisitorBridge> HTML_VISITOR_BRIDGES =
  ...
  private int handleVisitElementStart(
  ...
  private int handleVisitTableStart(
      MemorySegment userData,
      MemorySegment _ctx_in,
      MemorySegment outResult,
      MemorySegment outError) {
  ...
  private int handleVisitTableRow(
    ...
    try {
      ...
      List<String> _cells =
          JSON.readValue(
              _cells_json, new com.fasterxml.jackson.core.type.TypeReference<List<String>>() {});
  ...
  private int handleVisitLineBreak(
      MemorySegment userData,
      MemorySegment _ctx_in,
      MemorySegment outResult,
      MemorySegment outError) {
  ...
  private int handleVisitHorizontalRule(
      MemorySegment userData,
      MemorySegment _ctx_in,
      MemorySegment outResult,
      MemorySegment outError) {
  ...
  private int handleVisitFigureStart(
      MemorySegment userData,
      MemorySegment _ctx_in,
      MemorySegment outResult,
      MemorySegment outError) {
  ...
  public static void registerHtmlVisitor(final IHtmlVisitor impl, String name) throws Exception {
    ...
    try {
      try (var nameArena = Arena.ofConfined()) {
        ...
        int rc =
            (int)
                NativeLib.HTM_REGISTER_HTML_VISITOR.invoke(
