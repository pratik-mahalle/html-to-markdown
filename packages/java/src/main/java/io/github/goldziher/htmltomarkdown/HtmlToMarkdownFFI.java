...
/**
 * Low-level Foreign Function Interface (FFI) bindings to the native
 * html-to-markdown library.
 * <p>
 * This class provides direct access to the C FFI functions using Java's
 * Foreign Function &amp; Memory API (Panama). For a higher-level, more
 * ergonomic API, use {@link HtmlToMarkdown} instead.
 *
 * @since 2.7.3
 */
final class HtmlToMarkdownFFI {
    ...
    private static final FunctionDescriptor VERSION_DESC =
     ...
     * <p>
     * The returned MemorySegment must be closed by the caller to free
     * the native memory.
     *
