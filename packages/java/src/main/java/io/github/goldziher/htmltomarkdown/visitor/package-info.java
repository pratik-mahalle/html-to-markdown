 ...
 *
 * <ul>
 *   <li>{@link io.github.goldziher.htmltomarkdown.visitor.Visitor} - Main visitor interface
 *   <li>{@link io.github.goldziher.htmltomarkdown.visitor.NodeContext} - Context information for
 *       visited nodes
 *   <li>{@link io.github.goldziher.htmltomarkdown.visitor.VisitResult} - Result types controlling
 *       conversion behavior
 *   <li>{@link io.github.goldziher.htmltomarkdown.visitor.NodeType} - Enumeration of node types
 *   <li>{@link io.github.goldziher.htmltomarkdown.visitor.Attribute} - HTML attribute pairs
 * </ul>
 *
 ...
 *       io.github.goldziher.htmltomarkdown.visitor.VisitResult.Continue.INSTANCE} quickly unless
