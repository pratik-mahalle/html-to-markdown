 ...
 *
 * <p>Implementations are wrapped by HtmlVisitorBridge and exposed to the native runtime through
...
public interface IHtmlVisitor {
  ...
  /** visit_link. */
  VisitResult visit_link(NodeContext _ctx, String _href, String _text, String _title)
      throws Exception;

  /** visit_image. */
  VisitResult visit_image(NodeContext _ctx, String _src, String _alt, String _title)
      throws Exception;

  /** visit_heading. */
  VisitResult visit_heading(NodeContext _ctx, int _level, String _text, String _id)
      throws Exception;
  ...
  /** visit_list_item. */
  VisitResult visit_list_item(NodeContext _ctx, boolean _ordered, String _marker, String _text)
      throws Exception;
  ...
  /** visit_table_row. */
  VisitResult visit_table_row(NodeContext _ctx, List<String> _cells, boolean _is_header)
      throws Exception;
  ...
  VisitResult visit_custom_element(NodeContext _ctx, String _tag_name, String _html)
      throws Exception;
  ...
  /** visit_input. */
  VisitResult visit_input(NodeContext _ctx, String _input_type, String _name, String _value)
      throws Exception;
