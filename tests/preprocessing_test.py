...
def test_wikipedia_style_cleaning() -> None:
    html = """
    <html>
    <body>
...
def test_form_removal_integration() -> None:
    html = """
    <html>
    <body>
        <h1>Page Title</h1>
...
def test_wikipedia_navigation_removal() -> None:
    html = """
    <html>
    <body>
...
def test_custom_tag_removal() -> None:
    html = """
    <html>
    <body>
        <main>
    ...
    config = create_preprocessor("standard", custom_tags_to_remove={"advertisement", "cookie-banner", "social-widgets"})
    cleaned = preprocess_html(html, **config)
...
def test_class_based_navigation_removal() -> None:
    html = """
    <html>
    <body>
...
def test_direct_function_usage() -> None:
    html = """
    <html>
    <body>
        <nav>Navigation</nav>
