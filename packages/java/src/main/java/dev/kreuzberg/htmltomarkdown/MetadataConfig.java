...
public record MetadataConfig(@JsonProperty("extract_document") boolean extractDocument,
		@JsonProperty("extract_headers") boolean extractHeaders, @JsonProperty("extract_links") boolean extractLinks,
