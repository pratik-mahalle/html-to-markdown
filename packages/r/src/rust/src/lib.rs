...
pub struct MetadataConfig {
    ...
    pub max_structured_data_size: f64,
}
...
impl MetadataConfig {
    ...
    pub fn new(
        ...
        max_structured_data_size: Option<f64>,
    ) -> Self {
        Self { extract_document: extract_document.unwrap_or(true), extract_headers: extract_headers.unwrap_or(true), extract_links: extract_links.unwrap_or(true), extract_images: extract_images.unwrap_or(true), extract_structured_data: extract_structured_data.unwrap_or(true), max_structured_data_size: max_structured_data_size.unwrap_or_default() }
    }
...
#[extendr]
pub fn new_metadataconfig(
    extract_document: bool = TRUE,
    extract_headers: bool = TRUE,
    extract_links: bool = TRUE,
    extract_images: bool = TRUE,
    extract_structured_data: bool = TRUE,
    max_structured_data_size: f64 = 0
) -> MetadataConfig {
    MetadataConfig {
        extract_document,
        extract_headers,
...
pub struct MetadataConfigUpdate {
    ...
    pub max_structured_data_size: Option<f64>,
}
...
impl MetadataConfigUpdate {
    ...
    pub fn new(
        ...
        Self { extract_document: extract_document, extract_headers: extract_headers, extract_links: extract_links, extract_images: extract_images, extract_structured_data: extract_structured_data, max_structured_data_size: max_structured_data_size }
    }
}

#[extendr]
pub fn new_metadataconfigupdate(
